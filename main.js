...
function d2r(degrees) { // Turn degrees into Radients
  var pi = Math.PI;
...
const camera = new THREE.PerspectiveCamera( 50, width / window.innerHeight, 1, 900 );
...
const material = new THREE.MeshBasicMaterial( {color: 0x151516, side: THREE.DoubleSide} );
